...
namespace Photon.Chat.Demo
{
    ...
    ///
    /// Workflow:
    /// Create ChatClient, Connect to a server with your AppID, Authenticate the user (apply a unique myName,)
    ...
    public class ChatGui : MonoBehaviour, IChatClientListener
    {
        ...
        private void SendChatMessage(string inputLine)
        {
            ...
            if (doingPrivateChat)
            {
                // the channel myName for a private conversation is (on the client!!) always composed of both user's IDs: "this:remote"
        ...
        /// </summary>
        /// <param myName="user">myName of the user.</param>
        /// <param myName="status">New status of that user.</param>
        /// <param myName="gotMessage">True if the status contains a message you should cache locally. False: This status update does not include a
        /// message (keep any you have).</param>
        /// <param myName="message">Message that user set.</param>
